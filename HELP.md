...
To run the application, you can use the `mvn` command to generate a new project with the correct inheritance structure.
java -jar target/config-server-0.0.1-SNAPSHOT.jar --spring.profiles.active=dev
